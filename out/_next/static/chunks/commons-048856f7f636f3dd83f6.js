          ...
          a(this, t),
            ...
            (this.onPopState = function (t) {
              ...
              if (e) {
                ...
                i.changeState(
                  "replaceState",
                  (0, h.formatWithValidation)({ pathname: k(s), query: u }),
                  (0, h.getURL)()
                );
              }
            }),
                          ...
                          switch ((e.prev = e.next)) {
                            ...
                            case 50:
                              if (
                                ...
                                "/_error" !==
                                  (P = P
                                    ? (0, s.removePathTrailingSlash)(E(P))
                                    : P) &&
                                  ((b.pathname = A(P, j)),
                                  b.pathname !== P &&
                                    ((P = b.pathname),
                                    (o = (0, h.formatWithValidation)(b)))),
                                (D = (0, s.removePathTrailingSlash)(P)),
                                R(a))
                              ) {
                                e.next = 60;
                                break;
